...
class Home_screen:
    ...
    def draw(self, screen, size_window):
        ...
        combat_environment = self.font_secondary.render("Press e to go to the combat environment", False, "white")
        screen.blit(combat_environment, ((size_window[0]/2.6, size_window[1]/2+110)))